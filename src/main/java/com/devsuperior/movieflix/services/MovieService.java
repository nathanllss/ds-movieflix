...
public class MovieService {
    ...
    public Page<MovieCardDTO> findByGenre(String genreId, Pageable pageable) {
        ...
        Page<MovieCardProjection> pageResult = movieRepository.searchMoviesByGenre(id, pageable);
        ...
        entities = (List<MovieCardDTO>) Util.replace(pageResult.getContent(), entities);
